...
{!! Form::open(['route' => ['profiles.restore',':USER_ID'], 'method' => 'HEAD', 'id'=>'form-restore', 'role'=>'form']) !!}
{!! Form::close() !!}
{!! Form::open(['route' => ['profiles.force_destroy',':USER_ID'], 'method' => 'HEAD', 'id'=>'form-force_destroy', 'role'=>'form']) !!}
{!! Form::close() !!}
@endsection
